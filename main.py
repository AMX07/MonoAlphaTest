...
# -*- coding: utf-8 -*-
"""Basic functions for decoding mono-alpha cipher 
"""
...
class Breaker(object):
    ...
    def _hill_climbing(self, key, cipher_bin, char_positions):
        ...
        Generate a random key, called the 'parent', decipher the ciphertext using this key.
        Rate the fitness of the deciphered text, store the result.
        Change the key slightly (swap two characters in the key at random), measure the fitness
        of the deciphered text using the new key.
...
###############################################################################################
### code to be changed begins;

# Define your ciphertext here
ciphertext = "Zggp zg rteknhz/tfeknhz vozi Eqtlqk eohitk (gk Eqtlqk egrt), q lioyz eohitk, gft gy zit dglz tqln qfr dglz yqdgxl tfeknhzogf lnlztdl, ziqz xltl zit lxwlzozxzogf gy q ptzztk wn qfgzitk gft yxkzitk of zit qphiqwtz."
...
#/Users/anshm/SubstitutionBreaker-master/subbreaker/quadgram/EN.json